	...
	var questions = [
		{
			name: 'username',
			type: 'input',
			message: 'Enter your Githhub username or e-mail address:',
...
function createRepo(callback){
	...
	[
		...
		},
		{
			...
			message: 'Enter a description of the repository (optionaly):'
		},
		{
			type: 'list',
			name: 'visibility',
...
githubAuth(function (err, authed) {
	 if (err)
	 {
	 	switch (err.code) {
	 		case 401:
	 			console.log(chalk.red('Couldnt log you in. Please try again.'));
	 			break;
	 		default:
